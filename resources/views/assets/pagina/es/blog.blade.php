 ...
 .jssorl-009-spin img {
  ...
  <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:380px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
            <div>
                <img data-u="image" src="/plantilla/sliderblog/img/011.jpg" />
            </div>
            <div>
                <img data-u="image" src="/plantilla/sliderblog/img/012.jpg" />
            </div>
            <div>
                <img data-u="image" src="/plantilla/sliderblog/img/013.jpg" />
            </div>
            <div>
                <img data-u="image" src="/plantilla/sliderblog/img/014.jpg" />
            </div>
            <div>
                <img data-u="image" src="/plantilla/sliderblog/img/015.jpg" />
            </div>
            <div>
                <img data-u="image" src="/plantilla/sliderblog/img/016.jpg" />
            </div>
        </div>
        <!-- Bullet Navigator -->
